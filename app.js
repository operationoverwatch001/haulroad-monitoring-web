...
/* INTRO SPLASH SCREEN & CYBER GLITCH STYLES  */
...
.splash-logo {
  ...
  filter: drop-shadow(0 0 25px rgba(184, 20, 50, 0.8));
...
#loading-bar {
  ...
  background: linear-gradient(90deg, #b81432, #ff2b54);
...
@keyframes logoPulse {
  ...
  50% { transform: scale(1.04); opacity: 1; filter: drop-shadow(0 0 35px rgba(184, 20, 50, 0.95)); }
...
/* BOTTOM PANEL (FREE RESIZABLE BY DRAGGING PC & MOBILE)      */
...
/* LABEL TEKS ROTASI MENGIKUTI KOTAK JALAN (PERSIS FOTO 1)    */

/* ========================================================== */

.leaflet-tooltip.sta-rotated-label,

.leaflet-tooltip.grade-badge-label {
...
.leaflet-tooltip.sta-rotated-label::before,

.leaflet-tooltip.grade-badge-label::before {
...
/* Teks STA: Posisi di Tengah Blok & Terputar Mengikuti Badan Jalan */
...
/* Badge Kapsul Putih Persentase Grade di Luar Kotak */
...
.badge-grade-box.overgrade {

  border: 1.2px solid #c00000 !important;

}



.badge-grade-box.warning {
